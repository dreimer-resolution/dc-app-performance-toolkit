...
# this action should be the first one
def test_0_selenium_app_specific_login(bamboo_webdriver, bamboo_datasets, bamboo_screen_shots):
...
def test_2_selenium_z_log_out(bamboo_webdriver, bamboo_datasets, bamboo_screen_shots):
    ...
    # extension_ui.app_specific_logout(bamboo_webdriver,0 bamboo_datasets)
